...
- [x] Wave 0 covers all MISSING references (fixtures/mocks land in 02-01)
- [x] No watch-mode flags
- [x] Feedback latency < 15s
- [x] `nyquist_compliant: true` set in frontmatter

**Approval:** approved 2026-06-03 (plan-checker verified every task wires `<automated>` verify; Wave 0 fixtures/mocks scheduled in 02-01). `wave_0_complete` flips true during execution.
